                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="f-w-400 f-10"> <a class="line-clamp"
                                                            href="cart.html">Delayed Delivery</a></td>
                                                    <td>
                                                        <div class="progress-value d-flex gap-2 align-items-center">
                                                            <div class="progress">
                                                                <div class="progress-bar bg-primary" role="progressbar"
                                ...
                                <ul>
                                    <li class="d-flex top-product gap-2">
                                        <div><img class="img-fluid product-img"
                                                src="../assets/images/dashboard-3/product/1.png" alt="product" /></div>
                                    ...
                                    <li class="d-flex top-product gap-2">
                                        <div><img class="img-fluid product-img"
                                                src="../assets/images/dashboard-3/product/2.png" alt="product" /></div>
                                        <div class="w-100 d-flex justify-content-between align-items-center">
                                            <div class="product-details">
                                                <div><span class="badge rounded-pill badge-light text-dark">SKU78589</span>
                                                    ...
                                                    class="f-10 f-w-500 txt-primary">$45.26</span>
                                            </div>
                                            <div class="product-items">
                                                <div class="common-space gap-1"><span class="f-10 f-w-500 f-light">QTY
                                    ...
                                    <li class="d-flex top-product gap-2">
                                        <div><img class="img-fluid product-img"
                                                src="../assets/images/dashboard-3/product/3.png" alt="product" /></div>
                                        <div class="w-100 d-flex justify-content-between align-items-center">
                                            <div class="product-details">
                                                <div><span class="badge rounded-pill badge-light text-dark">SKU78599</span>
                                                    ...
                                                    Women Footwear</a><span class="f-10 f-w-500 txt-primary">$45.62</span>
                                            </div>
                                            <div class="product-items">
                                                <div class="common-space gap-1"><span class="f-10 f-w-500 f-light">QTY :
                                                    </span><span class="f-10 f-w-500">9</span></div>
                                    ...
                                    <li class="d-flex top-product gap-2">
                                        <div><img class="img-fluid product-img"
                                                src="../assets/images/dashboard-3/product/4.png" alt="product" /></div>
                                        <div class="w-100 d-flex justify-content-between align-items-center">
                                            <div class="product-details">
                                                <div><span class="badge rounded-pill badge-light text-dark">SKU78596</span>
                                                    ...
                                                    Half Sleev T-shirt</a><span
                                                    class="f-10 f-w-500 txt-primary">$589.26</span>
                                            </div>
                                            <div class="product-items">
                                                <div class="common-space gap-1"><span class="f-10 f-w-500 f-light">QTY
                                                        :</span><span class="f-10 f-w-500">9</span></div>
                                ...
                                <ul>
                                    <li>
                                        <div class="space-common d-flex user-name"><img
                                                ...
                                                src="../assets/images/user/22.png" alt="user" />
                                                    ...
                                                    <div class="dropdown">
                                                        <div id="dropdownMenuButtonicon31" data-bs-toggle="dropdown"
                                                            ...
                                                            <svg class="invoice-icon">
                                                                <use href="../assets/svg/icon-sprite.svg#more-vertical">
                                                                </use>
                                                            </svg>
                                                        </div>
                                                        <div class="dropdown-menu dropdown-menu-end"
                                    ...
                                    <li>
                                        <div class="space-common d-flex user-name"><img
                                                class="img-40 rounded-circle img-fluid me-2"
                                                src="../assets/images/user/28.png" alt="user" />
                                            <div class="common-space w-100">
                                                <div>
                                    ...
                                    <li>
                                        <div class="space-common d-flex user-name"><img
                                                class="img-40 rounded-circle img-fluid me-2"
                                                src="../assets/images/user/24.png" alt="user" />
                                            <div class="common-space w-100">
                                                <div>
                                    ...
                                    <li>
                                        <div class="space-common d-flex user-name"><img
                                                class="img-40 rounded-circle img-fluid me-2"
                                                src="../assets/images/user/49.png" alt="user" />
                                            <div class="common-space w-100">
                                                <div>
                                                ...
                                                <div class="team-activity">
                                                    <div class="activity-data d-flex align-items-center gap-3">
                                                        <div class="common-space gap-2 ">
                                                            ...
                                                            <div class="activity-time"><span
                                                                    class="f-light f-w-500 f-10">5 min ago</span></div>
                                                        </div>
                                                        <div class="subtitle">
                                                ...
                                                <div class="team-activity">
                                                    <div class="activity-data d-flex align-items-center gap-3">
                                                        <div class="common-space gap-2 ">
                                                            ...
                                                            <div class="activity-time"><span
                                                                    class="f-light f-w-500 f-10">6 min ago</span></div>
                                                        </div>
                                                        <div class="subtitle">
                                                            <p class="f-w-400 f-10">Ralph has solved Mr.williams project.
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="team-activity">
                                                    <div class="activity-data d-flex align-items-center gap-3">
                                                        <div class="common-space gap-2 ">
                                                            ...
                                                            <div class="activity-time"><span
                                                                    class="f-light f-w-500 f-10">10 min ago</span></div>
                                                        </div>
                                                        <div class="subtitle">
                                                            <p class="f-w-400 f-10">Esther has changed his to active, now.
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="team-activity">
                                                    <div class="activity-data d-flex align-items-center gap-3">
                                                        <div class="common-space gap-2 ">
                                                            ...
                                                            <div class="activity-time"><span
                                                                    class="f-light f-w-500 f-10">11 min ago</span></div>
                                                        </div>
                                                        <div class="subtitle">
                                                ...
                                                <div class="team-activity">
                                                    <div class="activity-data d-flex align-items-center gap-3">
                                                        <div class="common-space gap-2 ">
                                                            ...
                                                            <div class="activity-time"><span
                                                                    class="f-light f-w-500 f-10">12 min ago</span></div>
                                                        </div>
                                                        <div class="subtitle">
                                                            <p class="f-w-400 f-10">Theresa has complete old task and new
                                                                one.</p>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div class="card-header card-no-border total-revenue pb-0">
                            ...
                            <div class="sales-chart-dropdown">
                                <ul class="balance-data">
                                    ...
                                    <li><span class="circle bg-primary-1"> </span><span class="f-light ms-1">Firefox
                                        </span></li>
                                    <li> <span class="circle bg-primary-2"> </span><span
                                            class="f-light ms-1">Safari</span></li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <table class=" w-100 tranaction-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="product-name"><a class=" f-14 f-w-500"
                                                        href="product.html">Floyd Miles</a></div>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="product-name"><a class=" f-14 f-w-500"
                                                        href="product.html">Ralph Edwards</a></div>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="product-name"><a class=" f-14 f-w-500"
                                                        href="product.html">Jerome Bell</a></div>
                                            </td>
                                            <td class="f-14 f-w-500">16 Nov, 2024</td>
